...
const AddAnswerQuestionRow = ({
  ...
  return (
    ...
    >
      <button
        className="hover:bg-blue-500/20 flex justify-center items-center px-2 transition-colors rounded place-self-stretch"
...
export default AddAnswerQuestionRow;
